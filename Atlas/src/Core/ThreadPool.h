...
namespace Atlas 
{
	//A custom mutex that has a counter added to it
	...
	public:
		...
		//Clears the memory of the thread-pool
		~ThreadPool();
		...
		void Sync();
	private:
		//The task each thread will complete
		void Thread(int index);
		//This will handle any exceptions that will be
		...
		//The list of exceptions generated by the separate threads
		...
		//Has the thread-pool already been created
		bool m_Created;
	};
}